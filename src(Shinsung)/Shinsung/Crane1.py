    ...
    try:
        ...
        while not bolProgramEnd:
            ...
            try:
                ...
                # In this moment, we let the server to change the Null value true so that Server can send a command
            ...
            while not bolEnd:
                ...
                if bolReConnect:
                    ...
                    if gintLastCommand < gintTotalCommand:
                        ...
                        # When the typical command arrives
                        elif len(received) == 4:
...
def xmove(xf, xc):
    ...
    # When the crane has to go to U
        ...
        # Other Cases
            ...
            LM1X.on_for_degrees(50, (aim-2)*bangle - 60, brake=True)
            for i in range(10,56):
                LM1X.on(60-i, brake=True)
